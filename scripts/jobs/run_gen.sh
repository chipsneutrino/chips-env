...
cd $PRODDIR/beam_nuel/charmccdis/scripts/gen/ && source $PRODDIR/beam_nuel/charmccdis/scripts/gen.sh
...
cd $PRODDIR/beam_numu/charmccdis/scripts/gen/ && source $PRODDIR/beam_numu/charmccdis/scripts/gen.sh
